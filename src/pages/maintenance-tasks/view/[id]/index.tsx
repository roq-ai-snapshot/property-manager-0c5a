...
import { getMaintenanceTaskById } from 'apiSdk/maintenance-tasks';
...
function MaintenanceTaskViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('maintenance_task', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/maintenance-tasks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Box>
              {hasAccess('maintenance_schedule', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/maintenance-schedules/view/${data?.maintenance_schedule?.id}`}>
                      {data?.maintenance_schedule?.start_date}
                    </Link>
                  </Text>
                </Flex>
              )}
