...
import { getSupplyOrderById } from 'apiSdk/supply-orders';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Supply Order Detail View
          </Text>
          {hasAccess('supply_order', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/supply-orders/edit/${data?.id}`} passHref legacyBehavior>
              <Button
